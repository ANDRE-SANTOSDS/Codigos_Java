...
public class Programa {
	...
	public static void realizarLocacao(Scanner sc, List<Locacao> locacoes, List<Cliente> clientes, List<Carro> carros) {
		...
		case 1:
			...
			sc.nextLine(); // Consumindo a quebra de linha
			locacao = new LocacaoDiaria(0, instanteLocacao, null, cliente, carro, diasPrevistos); // Criando o objeto
																									// locacao diária
			break;
		case 2:
	...
	public static void cadastrarCarro(Scanner sc, List<Carro> carros, Categoria economica, Categoria intermediaria,
			Categoria executiva, Categoria luxo) {
