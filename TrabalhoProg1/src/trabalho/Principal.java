...
Campeonato c1 = new Campeonato(2023, "Copa do Brasil");
		...
		while (true) {
		    ...
		    switch (opcao) {
		        case 1:
		            ArrayList<Partida> partidasOcorridas = c1.listarPartidasOcorridas();
		            System.out.println("Partidas ja ocorridas:");
		            for (Partida partida : partidasOcorridas) {
		                System.out.println(partida);
		            }
		            ArrayList<Partida> partidasNaoOcorridas = c1.listarPartidasNaoOcorridas();
		        ...
		        case 2:
		            ArrayList<Time> tabelaCampeonato = c1.listarTabelaDoCampeonatoSemOrdem();
		            ...
		            break;
		        case 3:
		            ArrayList<Time> tabelaCampeonatoEmOrdem = c1.listarTabelaDoCampeonato();
		        ...
		        case 5:
		            ...
		            ArrayList<Time> times = c1.getTimes();
